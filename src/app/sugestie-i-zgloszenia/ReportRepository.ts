...
export class ReportRepository {
  ...
  createReport(user: User, product: Product, category: TypeOfReport, description: string): Report {
    let temp: Report = new Report(this.index, user, product, category, description);
